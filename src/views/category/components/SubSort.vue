<template>
  <div class='sub-sort'>
    ...
    <div class="check">
      <AppCheckbox v-model="sortParams.inventory">仅显示有货商品</AppCheckbox>
      <AppCheckbox v-model="sortParams.onlyDiscount">仅显示特惠商品</AppCheckbox>
    </div>
  </div>
</template>
<script>
import { reactive, watch } from 'vue'
import AppCheckbox from '@/components/library/AppCheckbox.vue'
export default {
  ...
  setup (props, { emit }) {
    ...
    watch(sortParams, (newName, oldName) => {
      emit('sort-change', newName)
    })
    return {
      sortParams,
      changeSort
